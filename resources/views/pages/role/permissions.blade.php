                        ...
                        <form class="p-3" action="" method="post">
                            @csrf
                                <div class="form-group">
                                    ...
                                    <h5>Permission of <span class="text-success">{{$role->name}}</span></h5>
                                    <hr>
                                    ...
                                    <div class="row {{ $group->group_name }} ml-3">
                                        ...
                                        <div class="col-md-6 @if($role->hasPermissionTo($permission->name)) d-none @endif" id="unSelectedPermission_{{$permission->id}}">
                ...
                <div class="col-md-5">
                    ...
                    <h5>Provided Permissions</h5><hr>
							...
							<div id="provided_permission_group_{{$checked_group->group_name}}">
                                ...
                                @if($role->hasPermissionTo($checked_permission->name))
