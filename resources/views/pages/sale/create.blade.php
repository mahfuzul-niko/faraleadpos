        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="shadow rounded p-3">
                    <form method="POST"
                        action="@if ($sale) {{ route('sale.update', $sale->id) }} @else {{ route('sale.store') }} @endif">
                        @csrf
                        @if ($sale)
                            @method('PUT')
                        @endif
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" class="form-control" name="file_no"
                                    value="{{ optional($sale)->file_no ?? $last->file_no + 1 }}" required>
                                @error('file_no')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control" name="sale_date"
                                    value="{{ optional($sale)->sale_date ?? date('Y-m-d') }}">
                                @error('sale_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2"><!--Client-->
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="name"
                                    value="{{ optional($sale)->name }}" required>
                                @error('name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="mobile"
                                    value="{{ optional($sale)->mobile }}" required>
                                @error('mobile')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" class="form-control" name="bill_amount"
                                    value="{{ optional($sale)->bill_amount }}" required>
                                @error('bill_amount')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" id="installation_charge" class="form-control"
                                    name="installation_charge" value="{{ optional($sale)->installation_charge }}"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control" name="installation_date"
                                    value="{{ optional($sale)->installation_date }}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" id="advanced" class="form-control" name="advance"
                                    value="{{ optional($sale)->advance }}" oninput="calculateDue()" required>
                                @error('advance')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" id="due" class="form-control" name="due"
                                    value="{{ optional($sale)->due }}" required>
                                @error('due')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group text-right">
                            <button @if ($sale) id="updateSaleBtn" @else id="addSaleBtn" @endif
                                type="submit" class="btn btn-primary">
                                <i
                                    class="nav-main-link-icon si
